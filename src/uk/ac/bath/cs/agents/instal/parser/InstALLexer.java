// $ANTLR 3.3 Nov 30, 2010 12:45:30 InstAL.g 2011-05-01 12:10:39
...
public class InstALLexer extends Lexer {
    ...
    public final void mKEY_INST() throws RecognitionException {
        try {
            int _type = KEY_INST;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InstAL.g:735:10: ( ( 'institution' | 'inst' ) )
            // InstAL.g:735:12: ( 'institution' | 'inst' )
            {
            // InstAL.g:735:12: ( 'institution' | 'inst' )
            int alt3=2;
    ...
    public final void mKEY_TYPE() throws RecognitionException {
        try {
            int _type = KEY_TYPE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InstAL.g:736:10: ( 'type' )
            // InstAL.g:736:12: 'type'
            {
            match("type"); 
    ...
    public final void mKEY_EVENT() throws RecognitionException {
        try {
            int _type = KEY_EVENT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InstAL.g:737:11: ( 'event' )
            // InstAL.g:737:13: 'event'
            {
            match("event"); 
    ...
    public final void mKEY_WITH() throws RecognitionException {
        try {
            int _type = KEY_WITH;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InstAL.g:738:10: ( 'with' )
            // InstAL.g:738:12: 'with'
            {
            match("with"); 
    ...
    public final void mKEY_FLUENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InstAL.g:739:12: ( 'fluent' )
            // InstAL.g:739:14: 'fluent'
            {
            match("fluent"); 
    ...
    public final void mKEY_GENERATES() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InstAL.g:740:15: ( 'generates' )
            // InstAL.g:740:17: 'generates'
            {
            match("generates"); 
    ...
    public final void mKEY_INITIATES() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InstAL.g:741:15: ( 'initiates' )
            // InstAL.g:741:17: 'initiates'
            {
            match("initiates"); 
    ...
    public final void mKEY_TERMINATES() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InstAL.g:742:16: ( 'terminates' )
            // InstAL.g:742:18: 'terminates'
            {
            match("terminates"); 
    ...
    public final void mKEY_INITIALLY() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InstAL.g:744:15: ( 'initially' )
            // InstAL.g:744:17: 'initially'
            {
            match("initially"); 
    ...
    public final void mKEY_PERM() throws RecognitionException {
        try {
            int _type = KEY_PERM;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InstAL.g:747:10: ( 'perm' )
            // InstAL.g:747:12: 'perm'
            {
            match("perm"); 
    ...
    public final void mKEY_NONINERTIAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InstAL.g:749:17: ( 'noninertial' )
            // InstAL.g:749:19: 'noninertial'
            {
            match("noninertial"); 
    ...
    public final void mEVENT_KEY_CREATE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InstAL.g:752:2: ( ( 'create' | 'creation' ) )
            // InstAL.g:752:4: ( 'create' | 'creation' )
            {
            // InstAL.g:752:4: ( 'create' | 'creation' )
            int alt4=2;
    ...
    public final void mTYPE() throws RecognitionException {
        try {
            int _type = TYPE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InstAL.g:758:6: ( UCALPHA ( DIGIT | UCALPHA | LCALPHA | '_' )* )
            // InstAL.g:758:8: UCALPHA ( DIGIT | UCALPHA | LCALPHA | '_' )*
            {
            mUCALPHA(); 
            // InstAL.g:758:16: ( DIGIT | UCALPHA | LCALPHA | '_' )*
            loop5:
            do {
                int alt5=2;
    ...
    public final void mLITERAL() throws RecognitionException {
        try {
            int _type = LITERAL;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InstAL.g:759:9: ( INTEGER | ( LCALPHA ( DIGIT | UCALPHA | LCALPHA | '_' )* ) )
            int alt7=2;
            ...
            switch (alt7) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // InstAL.g:759:21: ( LCALPHA ( DIGIT | UCALPHA | LCALPHA | '_' )* )
                    {
                    // InstAL.g:759:21: ( LCALPHA ( DIGIT | UCALPHA | LCALPHA | '_' )* )
                    // InstAL.g:759:22: LCALPHA ( DIGIT | UCALPHA | LCALPHA | '_' )*
                    {
                    mLCALPHA(); 
                    // InstAL.g:759:30: ( DIGIT | UCALPHA | LCALPHA | '_' )*
                    loop6:
                    do {
                        int alt6=2;
    ...
    public final void mLT() throws RecognitionException {
        try {
            int _type = LT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InstAL.g:760:4: ( ( '<' | 'lt' | 'LT' ) )
            // InstAL.g:760:6: ( '<' | 'lt' | 'LT' )
            {
            // InstAL.g:760:6: ( '<' | 'lt' | 'LT' )
            int alt8=3;
            switch ( input.LA(1) ) {
    ...
    public final void mGT() throws RecognitionException {
        try {
            int _type = GT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InstAL.g:761:4: ( ( '>' | 'gt' | 'GT' ) )
            // InstAL.g:761:6: ( '>' | 'gt' | 'GT' )
            {
            // InstAL.g:761:6: ( '>' | 'gt' | 'GT' )
            int alt9=3;
            switch ( input.LA(1) ) {
    ...
    public final void mEQ() throws RecognitionException {
        try {
            int _type = EQ;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InstAL.g:762:4: ( ( '=' | '==' | 'eq' | 'EQ' ) )
            // InstAL.g:762:6: ( '=' | '==' | 'eq' | 'EQ' )
            {
            // InstAL.g:762:6: ( '=' | '==' | 'eq' | 'EQ' )
            int alt10=4;
            switch ( input.LA(1) ) {
    ...
    public final void mNE() throws RecognitionException {
        try {
            int _type = NE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InstAL.g:763:4: ( ( '!=' | 'ne' | 'NE' | '<>' ) )
            // InstAL.g:763:6: ( '!=' | 'ne' | 'NE' | '<>' )
            {
            // InstAL.g:763:6: ( '!=' | 'ne' | 'NE' | '<>' )
            int alt11=4;
            switch ( input.LA(1) ) {
    ...
    public final void mINTEGER() throws RecognitionException {
        try {
            // InstAL.g:768:18: ( ( DIGIT )+ )
            // InstAL.g:768:20: ( DIGIT )+
            {
            // InstAL.g:768:20: ( DIGIT )+
            int cnt12=0;
            loop12:
