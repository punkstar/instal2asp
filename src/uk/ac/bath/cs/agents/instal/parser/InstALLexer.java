// $ANTLR 3.3 Nov 30, 2010 12:45:30 InstAL.g 2011-06-16 09:10:30
...
public class InstALLexer extends Lexer {
    ...
    public final void mKEY_INST() throws RecognitionException {
        try {
            int _type = KEY_INST;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InstAL.g:797:10: ( ( 'institution' | 'inst' ) )
            // InstAL.g:797:12: ( 'institution' | 'inst' )
            {
            // InstAL.g:797:12: ( 'institution' | 'inst' )
            int alt3=2;
    ...
    public final void mKEY_TYPE() throws RecognitionException {
        try {
            int _type = KEY_TYPE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InstAL.g:798:10: ( 'type' )
            // InstAL.g:798:12: 'type'
            {
            match("type"); 
    ...
    public final void mKEY_EVENT() throws RecognitionException {
        try {
            int _type = KEY_EVENT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InstAL.g:799:11: ( 'event' )
            // InstAL.g:799:13: 'event'
            {
            match("event"); 
    ...
    public final void mKEY_WITH() throws RecognitionException {
        try {
            int _type = KEY_WITH;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InstAL.g:800:10: ( 'with' )
            // InstAL.g:800:12: 'with'
            {
            match("with"); 
    ...
    public final void mKEY_FLUENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InstAL.g:801:12: ( 'fluent' )
            // InstAL.g:801:14: 'fluent'
            {
            match("fluent"); 
    ...
    public final void mKEY_GENERATES() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InstAL.g:802:15: ( 'generates' )
            // InstAL.g:802:17: 'generates'
            {
            match("generates"); 
    ...
    public final void mKEY_INITIATES() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InstAL.g:803:15: ( 'initiates' )
            // InstAL.g:803:17: 'initiates'
            {
            match("initiates"); 
    ...
    public final void mKEY_TERMINATES() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InstAL.g:804:16: ( 'terminates' )
            // InstAL.g:804:18: 'terminates'
            {
            match("terminates"); 
    ...
    public final void mKEY_INITIALLY() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InstAL.g:806:15: ( 'initially' )
            // InstAL.g:806:17: 'initially'
            {
            match("initially"); 
    ...
    public final void mKEY_PERM() throws RecognitionException {
        try {
            int _type = KEY_PERM;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InstAL.g:809:10: ( 'perm' )
            // InstAL.g:809:12: 'perm'
            {
            match("perm"); 
    ...
    public final void mKEY_NONINERTIAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InstAL.g:811:17: ( 'noninertial' )
            // InstAL.g:811:19: 'noninertial'
            {
            match("noninertial"); 
    ...
    public final void mEVENT_KEY_CREATE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InstAL.g:814:2: ( ( 'create' | 'creation' ) )
            // InstAL.g:814:4: ( 'create' | 'creation' )
            {
            // InstAL.g:814:4: ( 'create' | 'creation' )
            int alt4=2;
    ...
    public final void mTYPE() throws RecognitionException {
        try {
            int _type = TYPE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InstAL.g:820:6: ( UCALPHA ( DIGIT | UCALPHA | LCALPHA | '_' )* )
            // InstAL.g:820:8: UCALPHA ( DIGIT | UCALPHA | LCALPHA | '_' )*
            {
            mUCALPHA(); 
            // InstAL.g:820:16: ( DIGIT | UCALPHA | LCALPHA | '_' )*
            loop5:
            do {
                int alt5=2;
    ...
    public final void mLITERAL() throws RecognitionException {
        try {
            int _type = LITERAL;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InstAL.g:821:9: ( INTEGER | ( LCALPHA ( DIGIT | UCALPHA | LCALPHA | '_' )* ) )
            int alt7=2;
            ...
            switch (alt7) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // InstAL.g:821:21: ( LCALPHA ( DIGIT | UCALPHA | LCALPHA | '_' )* )
                    {
                    // InstAL.g:821:21: ( LCALPHA ( DIGIT | UCALPHA | LCALPHA | '_' )* )
                    // InstAL.g:821:22: LCALPHA ( DIGIT | UCALPHA | LCALPHA | '_' )*
                    {
                    mLCALPHA(); 
                    // InstAL.g:821:30: ( DIGIT | UCALPHA | LCALPHA | '_' )*
                    loop6:
                    do {
                        int alt6=2;
    ...
    public final void mLT() throws RecognitionException {
        try {
            int _type = LT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InstAL.g:822:4: ( ( '<' | 'lt' | 'LT' ) )
            // InstAL.g:822:6: ( '<' | 'lt' | 'LT' )
            {
            // InstAL.g:822:6: ( '<' | 'lt' | 'LT' )
            int alt8=3;
            switch ( input.LA(1) ) {
    ...
    public final void mGT() throws RecognitionException {
        try {
            int _type = GT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InstAL.g:823:4: ( ( '>' | 'gt' | 'GT' ) )
            // InstAL.g:823:6: ( '>' | 'gt' | 'GT' )
            {
            // InstAL.g:823:6: ( '>' | 'gt' | 'GT' )
            int alt9=3;
            switch ( input.LA(1) ) {
    ...
    public final void mEQ() throws RecognitionException {
        try {
            int _type = EQ;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InstAL.g:824:4: ( ( '=' | '==' | 'eq' | 'EQ' ) )
            // InstAL.g:824:6: ( '=' | '==' | 'eq' | 'EQ' )
            {
            // InstAL.g:824:6: ( '=' | '==' | 'eq' | 'EQ' )
            int alt10=4;
            switch ( input.LA(1) ) {
    ...
    public final void mNE() throws RecognitionException {
        try {
            int _type = NE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InstAL.g:825:4: ( ( '!=' | 'ne' | 'NE' | '<>' ) )
            // InstAL.g:825:6: ( '!=' | 'ne' | 'NE' | '<>' )
            {
            // InstAL.g:825:6: ( '!=' | 'ne' | 'NE' | '<>' )
            int alt11=4;
            switch ( input.LA(1) ) {
    ...
    public final void mINTEGER() throws RecognitionException {
        try {
            // InstAL.g:830:18: ( ( DIGIT )+ )
            // InstAL.g:830:20: ( DIGIT )+
            {
            // InstAL.g:830:20: ( DIGIT )+
            int cnt12=0;
            loop12:
